...
## Prerequisites
 ...
 `k3d`, `kubectl` and `docker` are needed to move ahead. Please ensure you have run the `prep.sh` script from the [Liftoff](./liftoff.md) section to install these tools natively.
